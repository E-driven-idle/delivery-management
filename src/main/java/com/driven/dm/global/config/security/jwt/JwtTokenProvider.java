package com.driven.dm.global.config.security.jwt;
...
public class JwtTokenProvider {
    ...
    public String createToken(UUID id, String username, UserRole roles) {
        ...
        return BEARER_PREFIX + Jwts.builder().setClaims(claims).setIssuedAt(now)
            .setExpiration(expirationDate).signWith(key, signatureAlgorithm).compact();
    }
